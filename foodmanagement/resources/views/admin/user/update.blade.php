                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <form action="{{ route('admin.user.update', [$user->U_id]) }}" method="POST" novalidate
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-6 col-xs-12" name="email"
                                            value="{{ $user->email }}" required="required" type="email"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-6 col-xs-12" name="phone"
                                            value="{{ $user->phone }}" required="required" type="text"
                                            data-parsley-type="digits" data-parsley-minlength="10"
                                            data-parsley-maxlength="12" data-parsley-id="phone">
                                    </div>
                                </div>
                                {{-- Address --}}
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-6 col-xs-12" name="address"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-6 col-xs-12" name="password" id="password"
                                            placeholder="Set new password here or not" data-parsley-minlength="6"
                                            type="password">
                                    </div>
                                </div>
                                {{-- Confirm Password --}}
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input class="form-control col-md-6 col-xs-12" name="confirm_password"
                                            placeholder="Confirm your password" data-validate-linked="password"
                                            type="password">
                                    </div>
                                </div>
