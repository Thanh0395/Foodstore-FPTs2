                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_content">
                                    ...
                                    <form action="{{route('admin.food.update',[$food->F_id])}}" method="POST" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <select class="select2_single form-control" tabindex="-1" name="Cate_id">
                                                    <option value="{{$categoryOld->Cate_id}}" selected>{{$categoryOld->Cate_name}}</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea
                                                class="form-control" rows="3" placeholder="Some description about your food..."
