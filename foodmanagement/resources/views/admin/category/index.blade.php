                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 30%;">
                                                ...
                                                <a class="btn btn-warning btn-xs" href="{{route('admin.category.edit',[$category->Cate_id])}}" >
                                                    <i class="fa fa-pencil"></i> Edit
                                                </a>
                                                <a class="btn btn-danger btn-xs" href="{{route('admin.category.delete',[$category->Cate_id])}}" onclick="return confirm ('Are you sure to want to delete this')">
