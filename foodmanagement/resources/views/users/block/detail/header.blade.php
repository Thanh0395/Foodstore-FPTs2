<div style="background-color: #eee; padding: 2rem">
    <button type="button" class="btn btn-primary" style="background-color:orange">Back To Home</button>

    <button type="button" class="btn btn-secondary" style="background-color:green">Product</button>
</div>
<div class="container">
    <div class="col-lg-8 border p-3 main-section bg-white">
        ...
        <div class="row m-0">
            <div class="col-lg-4 left-side-product-box pb-3">
                <img src=" {{asset($food->image)}} " class="border p-3">
                <span class="sub-img">
                ...
                <div class="right-side-pro-detail border p-3 m-0">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p class="m-0 p-0">It's name food?</p>
                        </div>
                        <div class="col-lg-12">
                            <p class="m-0 p-0 price-pro">VND?</p>
                            <hr class="p-0 m-0">
                        </div>
