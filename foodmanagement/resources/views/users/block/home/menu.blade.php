            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <h5 class="title-caption text-center">
                        ...
                        At Il Corda Charcoal Ste    At Il Corda Charcoal Steakhouse, we take pride in our signature charcoal flame grilling technique that gives our steaks an aromatic sear.
                ...
                <div class="tab-menu">
                    ...
                    <div class="slider slider-single">
                        <div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/start_menu_01.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Samon Marinted</h3>
                                        <p>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/start_menu_02.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Ceasar Salad</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/start_menu_03.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Appetizer 5 kinds</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                        </p>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/start_menu_04.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Mix Grenn Salad</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                        </p>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/start_menu_06.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Octopus Salami</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                        </p>
                                    </div>
                        ...
                        <div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/pasta_menu_01.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Carbonara</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/pasta_menu_02.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Pescatore</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/pasta_menu_03.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Rigatoni Ragu</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                        ...
                        <div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/dessert_menu_01.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Fontdant Chocolate</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                                        </p>
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/dessert_menu_02.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Tart With Fig</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/dessert_menu_03.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Mouse perry</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                <div class="offer-item">
                                    <img src="{{asset('assets/clients/images/dessert_menu_04.jpg')}}" alt="" class="img-responsive">
                                    <div>
                                        <h3>Gelato</h3>
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis eleifend dapibus.
