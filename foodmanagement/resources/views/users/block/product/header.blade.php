            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="d-none d-lg-flex ms-2">
                    ...
                    <a style="position: relative;" class="btn-sm-square bg-white rounded-circle ms-3" href="{{route('user.product.showCart')}}">
                        ...
                        <small class="" style="background-color: red;border-radius: 50%; padding: 0px 6px; position: absolute; top:-8px; right: -12px; z-index: 1; color: white"><Strong id="cartCount"></Strong></small>
                    </a>
