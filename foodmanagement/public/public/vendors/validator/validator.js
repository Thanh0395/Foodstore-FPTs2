...
var validator = (function($){
    var message, tests, checkField, validate, mark, unmark, field, minmax,priceminmax, defaults,
    ...
    */
    message = {
        ...
        number_min      : 'too low',
        number_max      : 'too high',
        price_min       : 'price too low',
        price_max       : 'price too high',
        url             : 'invalid URL',
        number          : 'not a number',
    ...
    */
    tests = {
        ...
        number : function(a){
            ...
            else if( minmax[1] && (a|1) > minmax[1] ){
                alertTxt = message.number_max;
                return false;
            }
            //viet them min max cho price
            else if( priceminmax[0] && (a|0) < priceminmax[0] ){
                alertTxt = message.price_min;
                return false;
            }
            else if( priceminmax[1] && (a|1) > priceminmax[1] ){
                alertTxt = message.price_max;
                return false;
            }
            return true;
        },
